...
import { EMPTY_TABS, activeOptionTab } from '../constants/constant';
...
export default function Email() {
  ...
  return (
    <div style={openDrawer ? {marginLeft:250,width:'calc(100%-250px)'}:{width:'100%'}}>
        ...
        <Emailtype activeOption={activeOption} handleOptionClick={handleOptionClick} />
        { (activeOption === 'Social') &&
            // <div style={{display:'flex',alignItems:'center',flex: '1',marginTop:100,marginLeft:200 }}>There are no mails to display</div>
            <NoMails message={activeOptionTab['Social']}/>
        }
        { (activeOption === 'Promotions') &&
            // <div style={{display:'flex',alignItems:'center',flex: '1',marginTop:100,marginLeft:200 }}>There are no mails to display</div>
            <NoMails message={activeOptionTab['Promotions']}/>
        }
